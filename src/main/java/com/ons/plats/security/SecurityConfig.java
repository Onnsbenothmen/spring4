...
public class SecurityConfig  {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                        ...
                        .requestMatchers("/showCreate", "/savePlat" ).hasAnyAuthority("ADMIN","AGENT")
                        .requestMatchers("/ListePlats").hasAnyAuthority("ADMIN","AGENT","USER")
                        .requestMatchers("/supprimerPlat","/modifierPlat","/updatePlat").hasAuthority("ADMIN")
                .anyRequest().authenticated().and()
                                .formLogin(form -> form
                                        .loginPage("/login")
                                        .defaultSuccessUrl("/ListePlats", true)
